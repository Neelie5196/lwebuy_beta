...
if(isset($_POST['update']))
    {
        ...
        for ($i = 0; $i < $count ; $i++)
        {
	        ...
	        $update3 = mysqli_query($con, "INSERT INTO log SET action='delivered $t_codes', created_at=now(), user_id='$user_id', sort_by='update'") or die(mysqli_error($con));
	   }
?>
                        ...
                        <form action="delivered.php" method="post">
                            ...
                            <table class="purchasetable">
                                ...
                                <tr class="bodyrow">
                                    ...
                                    <td><input type="text" name="signedname[]" class="tblformfield textinput" disabled /></td>
                                </tr>
