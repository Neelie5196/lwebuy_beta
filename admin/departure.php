<div class="col-xs-12 col-md-12 col-lg-12">
    <h2 class="bigh2 pagetitle hidden-xs hidden-sm">Shipments Departure</h2>
    
    <h2 class="smh2 pagetitle hidden-md hidden-lg">Shipments Departure</h2>
            ...
            <form action="arrival.php" method="post">
                <table class="purchasetable">
                    ...
                    <tr class="bodyrow">
                        ...
                        <td></td>
                        <td></td>
                        <td><input type="text" name="depart" class="tblformfield" required /></td>
                    </tr>
