...
if(isset($_POST['update']))
    {
        ...
        for ($i = 0; $i < $count ; $i++)
        {
            ...
            $eventDesc = 'Shipment departed from/to ' . addslashes($depart[$i]) . '.';
			...
			$update2 = mysqli_query($con, "INSERT INTO log SET action='updated $t_code[$i]', created_at=now(), user_id='$user_id'") or die(mysqli_error($con));
	   }
?>
