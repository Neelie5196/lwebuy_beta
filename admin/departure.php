...
if(isset($_POST['update']))
    {
        ...
        for ($i = 0; $i < $count ; $i++)
        {
            $eventDesc = 'Shipment departed from/to ' . $depart[$i] . '.';
			...
			$update2 = mysqli_query($con, "INSERT INTO log SET action='updated $t_code[$i]', created_at=now(), user_id='$user_id', sort_by='update'") or die(mysqli_error($con));
	   }
?>
     
<script>
alert('Shipment updated!');
window.location.href='departure.php';
</script>
...
<html>
    ...
    <body class="userbg">
        ...
        <div class="row userrow2 center" id="updateview">
            <div class="col-xs-12 col-md-12 col-lg-12">
                <h2 class="bigh2 pagetitle hidden-xs hidden-sm">Shipments Departure Update</h2>

                <h2 class="smh2 pagetitle hidden-md hidden-lg">Shipments Departure Update</h2>
                        ...
                        <form action="departure.php" method="post">
                            <table class="purchasetable">
                                ...
                                <tr class="bodyrow">
                                    ...
                                    <td><input type="text" name="departure[]" class="tblformfield textinput" disabled /></td>
                                </tr>
