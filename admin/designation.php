...
if(isset($_POST['update']))
    {
        ...
        for ($i = 0; $i < $count ; $i++)
        {
            $eventDesc = 'Shipment designated to ' . $designated[$i] . '.';
            
            $update0 = mysqli_query($con, "UPDATE shipping SET status = 'In Transit' WHERE tracking_code = $t_code[$i]") or die(mysqli_error($con));
            
            $update1 = mysqli_query($con, "INSERT INTO shipping_update_details SET HawbNo='$t_code[$i]', StationCode='$ostationcode', StationDescription='$ostationname', CountryCode='$ocountrycode', CountryDescription='$ocountryname', EventCode='DST', EventDescription='$eventDesc', ReasonCode='IS', ReasonDescription='Is Shipping', Remark=''") or die(mysqli_error($con));
			
            $update2 = mysqli_query($con, "INSERT INTO log SET action='designated $t_code[$i]', created_at=now(), user_id='$user_id', sort_by='update'") or die(mysqli_error($con));
		}
?>
...
<html>
    ...
    <body class="userbg">
        ...
        <div class="row userrow2 center" id="updateview">
            <div class="col-xs-12 col-md-12 col-lg-12">
                <h2 class="bigh2 pagetitle hidden-xs hidden-sm">Designated Shipments</h2>

                <h2 class="smh2 pagetitle hidden-md hidden-lg">Designated Shipments</h2>
                        ...
                        <form action="designation.php" method="post">
                            ...
                            <table class="purchasetable">
                                ...
                                <tr class="bodyrow">
                                    ...
                                    <td><input type="text" name="designatedto[]" class="tblformfield textinput" disabled /></td>
                                </tr>
