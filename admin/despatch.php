...
if(isset($_POST['update']))
    {
        ...
        for ($i = 0; $i < $count ; $i++)
        {
			...
			$update2 = mysqli_query($con, "INSERT INTO log SET action='despatched $t_code[$i]', created_at=now(), user_id='$user_id', sort_by='update'") or die(mysqli_error($con));
		}
?>
...
<html>
    ...
    <body class="userbg">
        ...
        <div class="row userrow2 center" id="updateview">
            <div class="col-xs-12 col-md-12 col-lg-12">
                <h2 class="bigh2 pagetitle hidden-xs hidden-sm">Despatched Shipments Update</h2>

                <h2 class="smh2 pagetitle hidden-md hidden-lg">Despatched Shipments Update</h2>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-12 col-lg-12 updatecontainer">
                        <form action="despatch.php" method="post">
                            <table class="purchasetable">
                                ...
                                <tr class="bodyrow">
                                    ...
                                    <td><input type="text" name="despatchby[]" class="tblformfield textinput" disabled /></td>
                                </tr>
